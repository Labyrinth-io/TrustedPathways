          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl shadow-xl p-4 sm:p-5 max-w-[200px] sm:max-w-[240px]">
              <div className="flex items-center gap-3 mb-2">
                ...
                <p className="font-semibold text-gray-900 text-sm">Support That Lets You Enjoy Life Again</p>
              </div>
              <p className="text-xs text-gray-500">With the right person by your side, even the little things can become beautiful memories.</p>
            </div>
          </div>
        </div>
      </div>
